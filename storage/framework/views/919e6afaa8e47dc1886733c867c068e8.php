<?php $__env->startSection('content'); ?>
    <section>
       <div class="container min-vh-100-edit p-5">
           ...
           <?php else: ?>
               <span class="text-primary font-28">No Terms and Conditions</span>
           <?php endif; ?>
       </div>
    </section>
...
<?php echo $__env->make('user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\localProjects\M9nuAws\resources\views/user/condition.blade.php ENDPATH**/ ?>