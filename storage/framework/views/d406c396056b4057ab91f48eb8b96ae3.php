      ...
      <span class="app-brand-logo demo mx-auto text-center">
        <img src="<?php echo e(asset('assets/images/logo.png')); ?>" width="55" class="mx-auto rounded" alt="">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item <?php echo e(request()->is('admin/condition') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.condition')); ?>" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-note"></i>
                        <div><?php echo app('translator')->get('messages.Conditions'); ?></div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(request()->is('admin/privacy') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.privacy')); ?>" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-note"></i>
                        <div><?php echo app('translator')->get('messages.Privacy Policy'); ?></div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(request()->is('admin/social') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.social')); ?>" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-note"></i>
                        <div><?php echo app('translator')->get('messages.Social'); ?></div>
                    </a>
                </li>
