                        ...
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-7">
                                <div class="card-body">
                                    ...
                                    <p class="mb-4">@lang('messages.You are now in the private control panel on the m9nuAws platform. Where you can control the platform')</p>
                        ...
                        <div class="col-lg-6 col-md-12 col-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title text-nowrap mb-1 pt-2 pb-3">station}</h3>
                        ...
                        <div class="col-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title text-nowrap mb-2">phase</h3>
...
{{--                                <p class="mt-2 text-muted font-10">{{ $parameters['count'] }} user in m9nuAws system</p>--}}
{{--                            </div>--}}
{{--                            <div class="col-3">--}}
...
{{--                                <p class="mt-2 text-muted font-10">{{ $parameters['totalSystems'] }} System in m9nuAws System </p>--}}
{{--                            </div>--}}
{{--                            <div class="col-3">--}}
...
{{--                    <img src="{{ asset('assets/images/logo.png') }}" width="30" alt="m9nuAws">--}}
...
{{--                            <h5 class="font-14 mb-0">Last updated m9nuAws</h5>--}}
{{--                        </div>--}}
{{--                        <div class="col-6 my-2 my-md-auto text-end">--}}
{{--                            <h5 class="text-primary font-14 mb-0">m9nuAws-2024</h5>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
