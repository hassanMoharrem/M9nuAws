...
<div class="layout-wrapper layout-content-navbar ">
    ...
    <div class="layout-container">
      ...
      <span class="app-brand-logo demo mx-auto text-center">
        <img src="{{ asset('assets/images/logo.png') }}" width="55" class="mx-auto rounded" alt="">
      </span>
{{--                    <span class="app-brand-text demo menu-text fw-bold ms-2">@lang('messages.m9nuAws')</span>--}}
                </a>
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ request()->is('admin/slider') ? 'active' : '' }}">
                    <a href="{{ route('admin.slider') }}" class="menu-link">
                        ...
                        <div>@lang('messages.Slider')</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->is('admin/step') ? 'active' : '' }}">
                    <a href="{{ route('admin.step') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-library"></i>
                        <div>@lang('messages.Step')</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->is('admin/advantage') ? 'active' : '' }}">
