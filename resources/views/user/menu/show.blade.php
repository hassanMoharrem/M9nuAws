    ...
    <section>
        <div class="text-center">
            <figure class="text-center pt-2">
                <img src="{{ $user->image }}" width="200" height="200" class="border border-3 border-primary text-end contain p-2 rounded-circle position-relative bg-white mx-auto" data-aos="zoom-in" data-aos-duration="1500"
                     alt="">
            </figure>
        </div>
        <div class="align-content-center mt-n-80">
            <figure>
                <img src="{{ asset($user->background) }}" class="w-100 cover bg-white" height="500px" alt="">
            </figure>
        </div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="background--dark d-md-flex justify-content-between align-items-center">
                        ...
                        <div class="footer-social d-md-block d-none">
                            <ul class="d-flex align-items-center justify-content-center list-unstyled">
                                ...
                                <li class="pb-0 px-2">
                                    <a href="{{ $user->instagram }}" target="_blank" class="{{ $user->instagram ? '' :'d-none'  }}">
                                        <i class="fa-brands fa-instagram font-20 text-white"></i>
                                    </a>
                                </li>
                                <li class="pb-0 px-2">
                                    <a href="{{ $user->whatsapp }}" target="_blank" class="{{ $user->whatsapp ? '' :'d-none'  }}">
